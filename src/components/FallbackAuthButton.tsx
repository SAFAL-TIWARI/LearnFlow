...
export default function FallbackAuthButton() {
  ...
  // Show sign in button with animated effect (we don't show authenticated state anymore as that's handled by UserProfile)
  return (
    <button
      onClick={handleSignIn}
      className="btn-animated bg-white text-gray-700 border border-gray-300"
    >
