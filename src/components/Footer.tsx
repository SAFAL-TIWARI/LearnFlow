    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-6">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
          ...
          <a href="/privacy-policy.html" className="text-gray-600 dark:text-gray-400 hover:text-learnflow-500 dark:hover:text-learnflow-400 transition-colors">Privacy Policy</a>
          <span className="mx-2 text-gray-600 dark:text-gray-400">|</span>
          <a href="/terms-of-service.html" className="text-gray-600 dark:text-gray-400 hover:text-learnflow-500 dark:hover:text-learnflow-400 transition-colors">Terms of Service</a>
        </div>
